package ru.otus.apigatewayservice.util;
...
public class ProjectStartingPoint implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        LOG.info("APIGATEWAY SERVICE ( BANK  ) is started!  {}", formattedDate);
    }
    ...
    public static void loggingApplicationParams(ConfigurableEnvironment environment) {
        ...
        LOG.info("""
                        ...
                        ________APIGATEWAY SERVICE ( BANK  )  PROJECT ________
                        APIGATEWAY SERVICE PROJECT STARTED SUCCESSFULLY!
