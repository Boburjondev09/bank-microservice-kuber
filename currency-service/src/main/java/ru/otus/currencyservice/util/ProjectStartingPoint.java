package ru.otus.currencyservice.util;
...
public class ProjectStartingPoint implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        LOG.info("CURRENCY SERVICE ( BANK  ) is started!  {}", formattedDate);
    }
    ...
    public static void loggingApplicationParams(ConfigurableEnvironment environment) {
        ...
        LOG.info("""
                        ...
                        ____CURRENCY SERVICE ( BANK  )  PROJECT ________
                        CURRENCY SERVICE ( BANK  ) PROJECT STARTED SUCCESSFULLY!
