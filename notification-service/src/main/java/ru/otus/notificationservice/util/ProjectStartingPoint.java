package ru.otus.notificationservice.util;
...
public class ProjectStartingPoint implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        LOG.info("NOTIFICATION SERVICE ( BANK  ) is started!  {}", formattedDate);
    }
    ...
    public static void loggingApplicationParams(ConfigurableEnvironment environment) {
        ...
        LOG.info("""
                        ...
                        ________NOTIFICATION SERVICE ( BANK  )  PROJECT ________
                        NOTIFICATION SERVICE PROJECT STARTED SUCCESSFULLY!
