package ru.otus.transactionservice.util;
...
public class ProjectStartingPoint implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        LOG.info("Transaction SERVICE ( BANK  ) is started!  {}", formattedDate);
    }
    ...
    public static void loggingApplicationParams(ConfigurableEnvironment environment) {
        ...
        LOG.info("""
                        ...
                        ____TRANSACTION SERVICE ( BANK  )  PROJECT ________
                        TRANSACTION SERVICE ( BANK  ) PROJECT STARTED SUCCESSFULLY!
