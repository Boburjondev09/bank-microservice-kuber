package ru.otus.accountservice.util;
...
public class ProjectStartingPoint implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        LOG.info("ACCOUNT SERVICE ( BANK  ) is started!  {}", formattedDate);
    }
    ...
    public static void loggingApplicationParams(ConfigurableEnvironment environment) {
        ...
        LOG.info("""
                        ...
                        ____ACCOUNT SERVICE ( BANK  )  PROJECT ________
                        ACCOUNT SERVICE ( BANK  ) PROJECT STARTED SUCCESSFULLY!
